...
export const generateRandomDepartDist = (
    numFaculty: number,
    numPME: number
): DepartmentDist =>
    expandObject({
...
export const RANDOM_NUM_ROOMS = 30;

export const generateRandomRooms = (numRooms: number) => {
    const rooms: Room[] = [];
...
export const generateRandomDepartments = (departmentDist: DepartmentDist) => {
