...
export interface DayTimetableDefaultProps {
...
export interface DayTimetableRequiredProps {
    // The timetable data
...
export const DayTimetable: React.FC<DayTimetableProps> = (props) => {
    const {
        calcCellHeight,
        caption,
        cellKey,
    ...
    for (let col = 0; col < numWeekDays; ++col) {
        const isFirstEvent = new Map<ReactNode, boolean>();
